...
def test():
    from ttdet.base_detectron import BaseDetectron, test_base_detectron, test_detectron_gui
    from kpick.detectron2_detector import DetectronDetector, test_detectron_gui

    # test_base_detectron(cfg_file='configs/mask_rcnn_R_50_FPN_3x.yaml')

    test_detectron_gui(cfg_file='configs/mask_rcnn_R_50_FPN_3x.yaml', run_realsense=True)
