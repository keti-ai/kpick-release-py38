...
```sh
from kpick.apps.mujin.detector import create_and_load_mujin_detector
detector = create_and_load_mujin_detector(cfg_path)
```
** cfg_path is default **kpick/apps/mujin/configs/suction.cfg** when cfg_path  is None or not given
